...
import ru.otus.otuskotlin.api.v2.apiV2ResponseDeserialize
import ru.otus.otuskotlin.api.v2.models.DishInitResponse
    ...
    fun initSession() {
        runBlocking {
            ...
            withTimeout(3000) {
                ...
                val message = apiV2ResponseDeserialize<DishInitResponse>(incame)
