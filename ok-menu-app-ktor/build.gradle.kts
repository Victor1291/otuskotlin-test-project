...
kotlin {
    ...
    targets.withType<org.jetbrains.kotlin.gradle.plugin.mpp.KotlinNativeTarget> {
        binaries {
            executable {
                entryPoint = "ru.otus.otuskotlin.menu.app.ktor.main"
            }
        }
    }
    ...
    sourceSets {
        val commonMain by getting {
            dependencies {
                ...
                implementation(project(":ok-menu-biz"))

                // v2 api
                implementation(project(":ok-menu-api-v2-kmp"))
                implementation(project(":ok-menu-mappers-v2"))
        ...
        val jvmMain by getting {
            dependencies {
                ...
                implementation(project(":ok-menu-mappers-v1"))
            }
        }
